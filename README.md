...
The title screen lets the player choose among the black pixel-art **MIDNIGHT**, golden **GOLDEN**, and dapple dachshund **DAPPLE** skins using the left/right arrow keys or the on-screen buttons. All three skins have four-direction leg and body walk cycles. Smooth acceleration, subtle procedural bob, tilt, squash and stretch, direction flipping, and a responsive ground shadow polish the animation.
